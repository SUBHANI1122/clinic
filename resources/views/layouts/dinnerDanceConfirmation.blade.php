            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="text-center bg-white" style="padding: 80px 0">
                        ...
                        <div class="col-12">
                            <p class="text-center text-color mb-0">Thank you for your support! We look forward to seeing you at the Medical Care & Physiotherapy Clinic 50th anniversary dinner dance.</p>
                            <p class="text-center text-color mb-0">An email receipt with details will follow shortly.</p>
                        </div>
                    </div>
                </div>
            </div>
